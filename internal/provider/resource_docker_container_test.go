...
func TestAccDockerContainer_customized(t *testing.T) {
	...
	testCheck := func(*terraform.State) error {
		...
		// see https://github.com/guru-terraform/terraform-provider-docker/issues/177
...
func testAccContainerNotRunning(n string, cont *types.ContainerJSON) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		ctx := context.Background()
